      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Performance Metrics Section with Premium Grid
            const SectionHeader(
            ...
            if (stats.recentActivities.isEmpty)
              const EmptyState(
                ...
                subtitle: 'Belum ada laporan yang dibuat untuk outlet ini baru-baru ini.',
                icon: Iconsax.clock,
              )
            else
              Container(
                ...
                child: Column(
                  children: List.generate(
                    ...
                    (index) {
                      ...
                      final isLast = index == stats.recentActivities.length - 1;
                      return Column(
                        children: [
                          Padding(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        act.details ?? 'Mengirim laporan sales',
            ...
            // Start Report Button with Premium Style
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
