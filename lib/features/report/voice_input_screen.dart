...
class _VoiceInputScreenState extends State<VoiceInputScreen> {
  ...
  final List<Map<String, dynamic>> _mockTranscripts = [
    ...
    {'time': 5, 'text': 'Melihat Indomie goreng sedang ada promo seharga Rp 2.500 per bungkus.'},
    {'time': 9, 'text': 'Stok di rak utama masih cukup melimpah, sekitar 50 bungkus.'},
    {'time': 13, 'text': 'Sementara Sedaap kari ayam mengalami kenaikan harga menjadi Rp 3.000.'},
    {'time': 18, 'text': 'Juga ada display baru dari produk kompetitor Sarimi dekat area kasir.'},
  ];
  ...
  void _updateWaveform() {
    if (_isRecording) {
      _waveHeights = List.generate(25, (index) => _random.nextDouble() * 40.0 + 4.0);
    } else {
          ...
          children: [
            ...
            AnimatedDefaultTextStyle(
              ...
              style: AppTextStyles.bodyLarge.copyWith(
                ...
                fontWeight: _isRecording ? FontWeight.w700 : FontWeight.w600,
              ),
              child: Text(
                _isRecording
                    ? 'Merekam suara...'
                    : (_seconds > 0 ? 'Perekaman dijeda' : 'Ketuk mikrofon untuk mulai'),
              ),
            ),
            const SizedBox(height: 40),

            // Animated Waveform (25 bars)
            Container(
              height: 70,
            ...
            // Transcript Preview Box with Gradient Background
            if (_hasRecorded) ...[
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
            ...
            Row(
              ...
              children: [
                ...
                // Record / Pause Button – Focal Point
                GestureDetector(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Icon(
                              _isRecording ? Iconsax.pause : Iconsax.microphone,
                              color: Colors.white,
                              size: 36,
                            ),
                          ),
                ...
                if (_hasRecorded && !_isRecording)
                  Container(
                    decoration: BoxDecoration(
                      color: _seconds >= 2 ? AppColors.successLight : AppColors.surfaceDisabled,
                      shape: BoxShape.circle,
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: SizedBox(
                          ...
                          child: Icon(
                            Iconsax.tick_circle,
                            color: _seconds >= 2 ? AppColors.success : AppColors.textDisabled,
                            size: 24,
                          ),
                        ),
                      ),
