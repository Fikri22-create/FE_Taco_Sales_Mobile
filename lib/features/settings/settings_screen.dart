...
class _SettingsScreenState extends State<SettingsScreen> {
    ...
    return Column(
      children: [
        _buildSwitchTile(
          ...
          subtitle: 'Dapatkan notifikasi aplikasi',
        ...
        if (_notificationsEnabled) ...[
          ...
          _buildSwitchTile(
            title: 'Getar',
            subtitle: 'Getar saat notifikasi baru masuk',
          ...
          _buildSwitchTile(
            ...
            subtitle: 'Pengingat untuk membuat laporan',
  ...
  Widget _buildAboutSection() {
    return Column(
      children: [
        _buildInfoTile(title: 'Versi Aplikasi', value: '1.0.0'),
        Divider(height: 1, color: AppColors.divider, indent: 16, endIndent: 16),
        _buildInfoTile(title: 'Build', value: '1'),
        Divider(height: 1, color: AppColors.divider, indent: 16, endIndent: 16),
        Padding(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(Iconsax.copy_copy, size: 16, color: AppColors.textTertiary),
          ],
        ),
      ),
    );
